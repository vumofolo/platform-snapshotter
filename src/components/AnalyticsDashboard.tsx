...
const modules = [{
  id: 2023,
  moduleNumber: 1,
  title: "Module 1 - Fellowship Welcome by Dr. T",
  sales: 10,
...
const roles = [{
  ...
  users: 25,
  firstActivated: "2025-03-03"
}, {
  title: "Admin role",
  users: 7,
  firstActivated: "2024-11-03"
}, {
  title: "Instructor role",
  users: 1,
  firstActivated: "2025-04-03"
}, {
  title: "Organization role",
  users: 1,
  firstActivated: "2025-01-15"
}, {
  title: "Author",
  users: 0,
  firstActivated: "2025-02-15"
}];
...
const messagePreview = [{
  username: "Dorothy Mutungura",
  subject: "Global Health Law",
  status: "Not replied",
  created: "2025-01-07 20:58"
}];
...
function ProgressRing({
  ...
  return <svg width={size} height={size} className="shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="12" fill="hsl(var(--foreground))">
        {label}
      </text>
    </svg>;
}
          ...
          <TabsContent value="roles">
            <Card className="mb-6">
              ...
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={roles.map(r => ({
                    name: r.title,
                    users: r.users
                  }))}>
                      <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" />
                      <XAxis dataKey="name" interval={0} angle={-15} textAnchor="end" height={60} tick={{
                      fill: "hsl(var(--muted-foreground))"
                    }} />
                      <YAxis tick={{
                      fill: "hsl(var(--muted-foreground))"
                ...
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={[...classesPerFellow].sort((a, b) => b.classes - a.classes).slice(0, 12)}>
                      <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" />
                      <XAxis dataKey="name" interval={0} angle={-20} textAnchor="end" height={70} tick={{
                      fill: "hsl(var(--muted-foreground))"
                    }} />
                      <YAxis tick={{
                      fill: "hsl(var(--muted-foreground))"
                ...
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={engagementByMonth}>
                      ...
                      <Tooltip />
                      <Line type="monotone" dataKey="entries" stroke="hsl(var(--analytics-primary))" strokeWidth={2} dot={{
                      fill: "hsl(var(--analytics-primary))"
                    }} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
